...
const plans = [
  {
    ...
    features: [
      ...
      { name: "Unlimited Text Reviews", included: true },
      { name: "Product Review Widgets", included: true },
      { name: "Manual Review Publishing", included: true },
      { name: "Manual Replies", included: true },
      { name: "20 AI Replies For Reviews & Q&A", included: true },
      { name: "Photo & Video Reviews", included: false },
      { name: "Smart Autopilot Publishing", included: false },
      { name: "AI Auto Reply Generation", included: false },
      { name: "Review Request Email Automation", included: false },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Everything In Free + Photo/Video Reviews", included: true },
      { name: "All Premium Widgets", included: true },
      { name: "Smart Autopilot Publishing", included: true },
      { name: "AI Auto Reply Generation", included: true },
      { name: "200 AI Replies For Reviews & Q&A", included: true },
      { name: "Review Request Email Automation", included: true },
    ],
